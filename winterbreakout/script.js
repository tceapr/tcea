const locks = [
  {
    ...
    title: 'Word Lock',
    badge: 'Word',
    label: 'No spaces or commas. Example: SNOW',
    answerHash: '685150f6'
  },
  {
    id: 'colorFive',
  ...
  },
  {
    ...
    title: '8 Letter Lock',
    badge: 'Letter',
    label: 'No spaces or commas. Example: ABCDEFGH',
    answerHash: '9e389c71'
  }
];
...
function startLeafCelebration() {
  ...
  for (let i = 0; i < 44; i += 1) {
    ...
    snowflake.style.setProperty('--x', `${Math.random() * 100}vw`);
    snowflake.style.setProperty('--drift', `${Math.random() * 220 - 110}px`);
    snowflake.style.setProperty('--duration', `${4.8 + Math.random() * 2.8}s`);
    snowflake.style.setProperty('--delay', `${Math.random() * 1.4}s`);
    snowflake.style.setProperty('--spin', `${Math.random() * 680 + 240}deg`);
    snowflake.style.setProperty('--flake-size', `${18 + Math.random() * 18}px`);
    leafCelebration.appendChild(snowflake);
  }
